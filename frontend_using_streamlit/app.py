...
def main():
    ...
    menu = ["Add User", "View Users", "Edit Users","View Movies","View Theatres and Screens","ShowIDs for Movies","Book Movie Tickets","View Bookings","Total Users","Total Movies","Ticket Details","Booked Users","Total Bookings","Remove"]
    ...
    if choice == "Add User":
        ...
        st.header("Ticket Details here:")
        display_ticket_details()
    
    elif choice == "Booked Users":
        st.subheader("View Users with Bookings")
        display_users_with_bookings()
